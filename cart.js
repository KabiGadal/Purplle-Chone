    ...
    cart.forEach(function (el, i) {
      ...
      product.innerHTML = `<div class="item">
            ...
            <div class="product-details">
              <h1><strong><span class="item-quantity">1</span> ${el.desc}</strong> </h1>
            
            </div>
          </div>
          <div class="price">${el.price_1}</div>
          <div class="quantity">
            <input type="number" value="1" min="1" class="quantity-field">
          </div>
          <div class="subtotal">${el.price_1}</div>
          <div class="remove">
            <button onclick='remove()'id="rmbtn${i}" value="${i}">Remove</button>
          </div>`;
